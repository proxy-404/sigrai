...
export default class Player extends THREE.Mesh {
    constructor(parameters, table) {
        ...
        /* TODO: #7 - Compute the rackets' lower and upper boundaries
        ...
        /* TODO: #2 - Create the racket (a rectangle) with properties defined by the following parameters:
            - width: this.size.x
            - height: this.size.y
            - color: this.color
        ...
        this.material = new THREE.MeshBasicMaterial(this.color);


        this.initialize();
    }

    /* TODO: #8 - Check the racket's lower and upper boundaries
    ...
    initialize() {
        ...
        this.score = 0;
        /* TODO: #3 - Set the racket's center position:
            - x: this.center.x
            - y: this.center.y
    ...
    update(deltaT) {
        /* TODO: #6 - Update the racket's center position
